...
namespace Sistema_Loja_Hardware
{
    class class_funcionario
    {
        ...
        {
            string query = " INSERT INTO funcionario VALUES (0, '" + nome + "', '" + data_nascimento.ToString("yyyy-MM-dd") + "', '" + sexo + "', '" + estado_civil + "', '" + cpf + "', '" + rg + "' , '" + salario.ToString().Replace(",", ".") + "', '" + endereco + "', " + numero + ", '" + complemento + "' , '" + bairro + "', '" + cidade + "', '" + estado + "', '" + cep + "', '" + telefone_residencial + "', '" + telefone_recado + "', '" + telefone_celular + "', '" + email + "', 1, now(), " + codigo_setor + ", " + codigo_cargo + " )  ";
